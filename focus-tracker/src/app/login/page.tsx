...
export default function LoginPage() {
  ...
  const {
    ...
    mode: "onBlur", // Validate on blur for login form
    defaultValues: {
      email: "",
      password: "",
    },
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-72 h-72 bg-cyan-400/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-fuchsia-400/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="card card-dark rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center space-x-2 py-3 px-4 rounded-xl border border-[var(--border)] hover:bg-[var(--card-hover)] hover:border-cyan-500/50 transition-all">
