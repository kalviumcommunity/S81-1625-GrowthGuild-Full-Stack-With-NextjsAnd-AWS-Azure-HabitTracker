      ...
      <div className="w-full max-w-md animate-fade-in-up">
        ...
        <div className="glass-card rounded-2xl p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-700 bg-gray-800 focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all outline-none text-white placeholder-gray-500"
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="flex items-center justify-center space-x-2 py-3 px-4 rounded-xl border border-gray-700 hover:bg-gray-800 transition-colors">
